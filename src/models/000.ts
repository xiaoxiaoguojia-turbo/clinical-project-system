...
export interface IUnifiedProject {
  ...
  status_其他项目的: string                 // 项目进展状态_其他项目（早期、临床前、临床阶段、上市产品）
  status_中药现代化: string                 // 项目进展状态_中药现代化（院内制剂、经验方、协定方、早期研究）
  status_医疗器械: string                   // 项目进展状态_医疗器械（早期、样品设计、型检、临床阶段、上市产品）



  leader: string                           // 负责人

  transformRequirementList?: string[]      // 转化需求列表
